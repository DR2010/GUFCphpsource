<?php
	/*
	Template Name: List Games in Memory
	*/
	get_header();
...
<html lang="en">
    <head>
		...
		<script language=JavaScript>
			...
			function reload2(form)
			{
				...
				self.location='?page_id=1227&agegroupselected=' + val + '&teamselected=' + val2;
			}
    ...
    <body>
        ...
        {
            if ($agegroup->agegroupid==$agegroupselected)
            {
		...
		{
			if ( $team->fkagegroupid == $agegroupselected )   
			{
