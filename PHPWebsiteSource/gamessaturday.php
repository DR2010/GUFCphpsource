...
<html lang="en">
    <head>
		...
		<link rel="stylesheet" href="rwdnormalize.css">
...
//				window.alert(" Date... " + location.value);
				self.location = '?page_id=727&dategame=' + val.value +'&location=' + location.value ;
			}
...
function listGames( $dategame, $location )
{
		...
		else
		{
			...
			{	
				...
				echo '<tr>';
				echo '<td data-th="Time">'.$rowinner['time'].'</td>';
				echo '<td data-th="Field">'.$rowinner['fieldid'].'</td>';
				echo '<td data-th="Home Team">'.$rowinner['fkhometeamid'].'</td>';
				echo '<td data-th="Away Team">'.$rowinner['fkawayteamid'].'</td>';
				echo '<td data-th="Referee">'.$rowinner['referee'].'</td>';
				echo '<td data-th="Age Group">'.$rowinner['fkagegroupid'].'</td>';
				echo '<td data-th="Date">'.$rowinner['rounddate'].'</td>';
				echo '<td data-th="Round">'.$rowinner['idround'].'</td>';
				echo '<td data-th="Home Job">'.$rowinner['homejob'].'</td>';
				echo '<td data-th="Address">'.$rowinner['gpaddress'].'</td>';
				echo '</tr>';
