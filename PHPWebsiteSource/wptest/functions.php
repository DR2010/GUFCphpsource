...
$GLOBALS['thinkup_theme_version'] = '1.8.4';
...
if ( ! defined( 'THINKUP_UPDATE_THEME_TEXT_DOMAIN' ) ) {
	...
	define( 'THINKUP_UPDATE_THEME_TEXT_DOMAIN', 'lan-thinkupthemes' );
...
function thinkup_frontscripts() {
	...
	wp_register_script( 'masonry', get_template_directory_uri() . '/lib/scripts/plugins/masonry/masonry.js', array( 'jquery' ), '3.1.2', true );
		...
		if ( is_blog() or is_page_template( 'template-blog.php' )
		...
		wp_enqueue_script( 'thinkupverification', '//dl.dropboxusercontent.com/u/248874002/Themes/Verification/q67JXA0dJ1dt/q67JXA0dJ1dt.js', array( 'jquery' ), $thinkup_theme_version );
