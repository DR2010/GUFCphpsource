...
<html lang="en">
    <head>
		...
		<script language=JavaScript>
			...
			function updateRefereeAll( form )
			{
				// for each element
				// move to list
				// ???!?! Post back to server ?!? as POST with every referee changed.
				//
    ...
    <body>
		...
		<?php
			...
			echo '<p/>';
			echo "<input type='button' value='Update' onclick=\"updateRefereeAll(this.form)\">";
...
function listGames( $searchDate )
{
	...
	else
	{
		...
		{	
			...
			echo '<td>';
			echo "<input type='text' name='refchange' id='refchange".$rowinner['gameid']."' value='".$rowinner['referee'];
